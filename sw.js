const CACHE_NAME = 'pass-cal-v1.3.135-unified-routine-list';
const PASS_SW_BUILD_VERSION = 'v1.3.135-unified-routine-list';
...
const CORE_ASSETS = [
  ...
  './assets/brand/www-app-icon-256.png',
  './assets/brand/www-app-icon-192.png',
  './assets/brand/www-app-icon-180.png',
  './assets/brand/www-app-icon-152.png',
  './assets/brand/www-app-icon-120.png',
  './assets/brand/www-app-icon-96.png',
  './assets/brand/www-app-icon-64.png',
  './assets/brand/www-app-icon-32.png',
